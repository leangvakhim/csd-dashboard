...
// Lazy loading the MediaLibraryModal component for performance
...
const SettingFieldBodyInfo = () => {
  ...
  const handleLocationClick = () => {
    // Show form when location dropdown is clicked
  ...
  const [formData, setFormData] = useState({
    ...
    e_fav: false,
    lang: 1,
    e_subtitle: "", // Added state for subtitle
  });
    ...
    <div className="px-8 py-2 mb-1">
      <div className="tabs">
        ...
        <div className="mt-4">
            ...
            <div className="grid grid-cols-1 md:!grid-cols-2 items-center gap-4">
              ...
              {isMediaLibraryOpen && (
                <Suspense fallback={<div>Loading...</div>}>
                  <MediaLibraryModal
                    onSelect={(imageUrl) =>
                      handleImageSelect(imageUrl, "image")
                    }
          ...
          {/* Third row */}
          <div className="w-full my-0 sm:my-6">
            <div className="flex sm:!flex-rowflex-col grid grid-cols-1 gap-4  ">
              <div className="flex-1">
                <div className="relative">
                  <div className="relative">
                    <div
                      onClick={handleLocationClick}
                      className="block w-full border border-gray-300 rounded-md px-4 py-3 text-lg text-black shadow-sm bg-gray-100 cursor-pointer"
                    >
                      Location
                    </div>
                  </div>
              ...
              {/* Show the form when the location dropdown is clicked */}
              {isFormVisible && (
                <div className="bg-gray-200 p-6 rounded-lg shadow space-y-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <div className="bg-white rounded-md border border-gray-300 px-4 py-10 flex justify-center items-center">
                        <input
                          type="file"
                          onChange={(e) =>
                            setFormData({
                    ...
                    <div>
                      ...
                      <div className="bg-white rounded-md border border-gray-300">
                        <textarea
                          ...
                          className="w-full px-4 py-2 text-black placeholder-gray-400 resize-none rounded-md"
          ...
          {/* Five row */}
          <div className="w-full my-0 sm:my-6">
            <div className="flex sm:!flex-rowflex-col grid grid-cols-1 gap-4  py-2">
              <div className="flex-1">
                <div className="relative">
                  <div className="relative">
                    <div
