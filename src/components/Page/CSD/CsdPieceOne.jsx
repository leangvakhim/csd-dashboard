<<<<<<< Updated upstream:src/components/Page/CSD/CsdPieceOne.jsx
...
>>>>>>> Stashed changes:src/components/Page/CSD/CsdPieceSlider.jsx
...
=======
const CsdPieceOne = forwardRef(({ csdId }, ref) => {
  const [rotatedStates, setRotatedStates] = useState({});
  ...
  useEffect(() => {
    const fetchSliders = async () => {
      try {
        ...
        if (subservices.length > 0 && csdId) {
          const validSubservices = subservices.filter(
            (item) => item.ss_ras === csdId
          );
