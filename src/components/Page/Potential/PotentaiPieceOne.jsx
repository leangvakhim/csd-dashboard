<<<<<<< Updated upstream:src/components/Page/Potential/PotentaiPieceOne.jsx
...
const PotentaiPieceOne = () => {
    ...
    const handleAddSlider = () => {
        const newSlider = {
            id: `${Date.now()}`,
            title: `potentail ${slider.length + 1}`,
            subtitle: "",
            logo: "",
            image: "",
            firstbtntitle: "",
...
const StudyPieceOne = forwardRef(({ studyId }, ref) => {
  ...
  const handleAddSlider = () => {
    const newSlider = {
      ...
      detail: "",
      display: 0,
>>>>>>> Stashed changes:src/components/Page/Study/StudyPieceSlider.jsx
    };
