    ...
    getGallery: async () => {
      ...
      try {
        const response = await axios.get(
          `${API_ENDPOINTS.getGallery}?gal_sec=${sectionId}`
        );
      ...
      try {
        ...
        if (galleries.length > 0) {
          ...
          if (gallery) {
            ...
            setSelectedImages({
              image1: gallery.image1?.img
                ? `${API}/storage/uploads/${gallery.image1.img}`
                : "",
              image2: gallery.image2?.img
                ? `${API}/storage/uploads/${gallery.image2.img}`
                : "",
              image3: gallery.image3?.img
                ? `${API}/storage/uploads/${gallery.image3.img}`
                : "",
              image4: gallery.image4?.img
                ? `${API}/storage/uploads/${gallery.image4.img}`
                : "",
              image5: gallery.image5?.img
                ? `${API}/storage/uploads/${gallery.image5.img}`
                : "",
            });
          }
        }
