...
const CareerDetailPiece = forwardRef(({sectionId, pageId, handleSectionRef}) => {
        ...
        <div className="grid grid-cols-1 gap-4 ">
            <details className="group [&_summary::-webkit-details-marker]:hidden rounded-lg">
                ...
                >
                    ...
                    <span className=" text-xl font-medium">Career Detail</span>
                    </div>
...
export default CareerDetailPiece