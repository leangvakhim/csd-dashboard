...
const ServicePiece = () => {
    const [isRotatedButton1, setIsRotatedButton1] = useState({}); // Store open/close state for each section
    const [isMediaLibraryOpen, setMediaLibraryOpen] = useState(false);
    const [selectedSections, setSelectedSections] = useState([
        { id: Date.now(), type: "Initial service", title: "", subtitle: "", display: true, image: "" },
    ]);
    ...
    const handleImageSelect = (imageUrl, sectionId) => {
        setSelectedSections(selectedSections.map(section => {
            if (section.id === sectionId) {
                return { ...section, image: imageUrl ? `${imageUrl}` : "" };
            }
            return section;
        }));
    ...
    const handleAddPage = () => {
        const newTag = { id: Date.now(), type: "New service", title: "", subtitle: "", display: true, image: "" };
    ...
    return (
        <div className="grid grid-cols-1 gap-4 ">
                                ...
                                >
                                    {(provided) => (
                                        ...
                                        >
                                            ...
                                            >
                                                <div className="cursor-pointer flex items-center justify-between w-full px-4" onClick={() => toggleSectionVisibility(section.id)}>
                                                    ...
                                                    <div className="flex gap-1">
                                                        ...
                                                        <div className={`cursor-pointer shrink-0 transition-transform duration-300 ${isRotatedButton1[section.id] ? 'rotate-180' : ''}`}>
                                                            <svg
                                                                xmlns="http://www.w3.org/2000/svg"
                                                                fill="none"
                                                                viewBox="0 0 24 24"
                                            ...
                                            {isRotatedButton1[section.id] && (
                                                <>
                                                        ...
                                                        <div className="flex-non">
                                                            ...
                                                            <div className="mt-2">
                                                                <label className="toggle-switch mt-2">
                                                                    <input type="checkbox" checked={section.display} onChange={() => handleToggleDisplay(section.id)} />
                                                    ...
                                                    <div className="grid grid-cols-1 md:!grid-cols-2 gap-4 px-4 py-2 mb-1">
                                                                    ...
                                                                    {section.image ? (
                                                                        <div>
                                                                            ...
                                                                            <div className="flex gap-3 mt-2 justify-center">
                                                                                ...
                                                                                <svg
                                                                                    onClick={() => handleImageSelect("", section.id)}
                                                                                    xmlns="http://www.w3.org/2000/svg"
                                                                                    fill="none"
                                                                                    viewBox="0 0 24 24"
                                                                                    strokeWidth="1.5"
                                                        ...
                                                        {isMediaLibraryOpen && (
                                                            <MediaLibraryModal
                                                                onSelect={(imageUrl) => handleImageSelect(imageUrl, section.id)}
            ...
            <a
                className={` cursor-pointer flex items-center py-3 text-sm font-medium text-blue-600 border-t border rounded-b-lg bg-gray-50 hover:bg-gray-100 hover:underline `}
