...
const ScholarshipPiece = forwardRef(({ sectionId, pageId }, ref) => {
  const [isRotatedButton1, setIsRotatedButton1] = useState(false);
        ...
        <summary className="cursor-pointer flex justify-between rounded-lg py-2 w-full ">
          ...
          >
            <div className="flex gap-1 items-center">
              ...
              <span className=" text-xl font-medium">Scholarship</span>
            </div>
...
<<<<<<< Updated upstream
                ...
                <div className="w-full flex justify-center items-center bg-gray-50 border p-6">
                    <div className="px-4 py-2 mb-1">
                        <span> Scholarship's Element</span>
                    </div>
                </div>
            </details>
        </div>
...
export default ScholarshipPiece;
