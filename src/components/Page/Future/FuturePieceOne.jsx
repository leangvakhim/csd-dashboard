<<<<<<< Updated upstream:src/components/Page/Future/FuturePieceOne.jsx
...
>>>>>>> Stashed changes:src/components/Page/Future/FuturePieceSlider.jsx
import { DragDropContext, Droppable, Draggable } from "react-beautiful-dnd";

<<<<<<< Updated upstream:src/components/Page/Future/FuturePieceOne.jsx
const FuturePieceOne = () => {
    ...
    const fetchSliders = async () => {
      try {
        ...
        if (subfutures.length > 0 && futureId) {
          const validSubservices = subfutures.filter(
            (item) => item.ufa_uf === futureId
          );
