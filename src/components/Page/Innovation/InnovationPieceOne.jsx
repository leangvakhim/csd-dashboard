<<<<<<< Updated upstream:src/components/Page/Innovation/InnovationPieceOne.jsx
...
>>>>>>> Stashed changes:src/components/Page/Potential/PotentialPieceSlider.jsx
import { DragDropContext, Droppable, Draggable } from "react-beautiful-dnd";
import MediaLibraryModal from "../../MediaLibraryModal";

<<<<<<< Updated upstream:src/components/Page/Innovation/InnovationPieceOne.jsx
const InnovationPieceOne = () => {
    ...
    const handleAddSlider = () => {
        const newSlider = {
            id: `${Date.now()}`,
            title: `innovation ${slider.length + 1}`,
            subtitle: "",
            logo: "",
            image: "",
            firstbtntitle: "",
...
export default InnovationPieceOne;
