...
const AnnouncementDetailPiece = forwardRef(({sectionId, pageId, handleSectionRef}) => {
        ...
        <div className="grid grid-cols-1 gap-4 ">
            <details className="group [&_summary::-webkit-details-marker]:hidden rounded-lg">
                ...
                >
                    ...
                    <span className=" text-xl font-medium">Announcement Detail</span>
                    </div>
...
export default AnnouncementDetailPiece