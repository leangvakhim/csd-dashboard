...
const sectionOptions = [
  ...
  },
  {
    ...
    component: () => (
      <div className="bg-gray-50 p-2 rounded-lg">
        <h1 className="text-xl font-bold text-center">Testimonial Section</h1>
      </div>
    ),
  ...
  },
  {
    ...
    component: () => (
      <div className="bg-gray-50 p-2 rounded-lg">
        <h1 className="text-xl font-bold text-center">Type Section</h1>
      </div>
    ),
    icon: LuFileType,
    label: "Type",
  },
  {
    ...
    component: () => (
      <div className="bg-gray-50 p-2 rounded-lg">
        <h1 className="text-xl font-bold text-center">Criteria Section</h1>
      </div>
    ),
    icon: TbBrandCarbon,
    label: "Criteria",
